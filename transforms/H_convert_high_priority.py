"""
H_convert_high_priority.py - Convert high priority TiddlyWiki markup to Markdown (UPDATED).
...
Usage:
    python transforms/H_convert_high_priority.py <input_folder>
    
Example:
    python transforms/H_convert_high_priority.py 01457A9BFG
    # Creates output folder: 01457A9BFGH
"""
...
def main() -> None:
    ...
    if len(sys.argv) != 2:
        ...
        print(f"Example: python {SCRIPT_ID}_{SCRIPT_NAME}.py 01457A9BFG")
        sys.exit(1)
