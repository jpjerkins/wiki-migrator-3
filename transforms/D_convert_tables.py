"""
D_convert_tables.py - Convert TiddlyWiki tables to Markdown tables.
...
Usage:
    python transforms/D_convert_tables.py <input_folder>
    
Example:
    python transforms/D_convert_tables.py 01457A9BC
    # Creates output folder: 01457A9BCD
"""
...
def main() -> None:
    ...
    if len(sys.argv) != 2:
        ...
        print(f"Example: python {SCRIPT_ID}_{SCRIPT_NAME}.py 01457A9BC")
        sys.exit(1)
