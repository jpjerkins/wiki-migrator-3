"""
C2_wikitext_to_markdown.py - Convert TiddlyWiki wikitext to Markdown (UPDATED).
...
Usage:
    python transforms/C2_wikitext_to_markdown.py <input_folder>
    
Example:
    python transforms/C2_wikitext_to_markdown.py 01457A9B
    # Creates output folder: 01457A9BC2
"""
