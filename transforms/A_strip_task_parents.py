"""
A_strip_task_parents.py - Strip needless parent entries from tasks (UPDATED).
...
Usage:
    python transforms/A_strip_task_parents.py <input_folder>
    
Example:
    python transforms/A_strip_task_parents.py 01457
    # Creates output folder: 01457A
"""
...
# Parents to strip from tasks (UPDATED: added Daily Focus)
PARENTS_TO_STRIP = {"Parked", "Today", "TodayCandidate", "Archive", "Task", "WhileOut", "Daily Focus"}
