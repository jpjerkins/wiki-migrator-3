"""
6_strip_task_parents.py - Strip needless parent entries from tasks.
...
Usage:
    python transforms/6_strip_task_parents.py <input_folder>
    
Example:
    python transforms/6_strip_task_parents.py 0145
    # Creates output folder: 01456
"""
...
# Parents to strip from tasks
PARENTS_TO_STRIP = {"Parked", "Today", "TodayCandidate", "Archive", "Task"}
...
def main() -> None:
    ...
    print(f"  3. Create the next transform script (7_*.py)")
